...
def process_weights_after_loading(
    ...
    # Optional quant-method post-load initializers run after every per-module
    # device_loading_context has restored UVA parameters.  Static expert-cache
    # builders need to see the final mapped-host tensors, not the temporary GPU
    # tensors used while repacking checkpoint weights.
    for _, module in model.named_modules():
        quant_method = getattr(module, "quant_method", None)
