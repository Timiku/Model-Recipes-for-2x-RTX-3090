...
"""Model-runner state for Qwen3.8-Flash-Next PLE inputs."""
...
class Qwen3_8FlashNextModelState(MambaHybridModelState):
    ...
    def __init__(
        ...
        ple_layer_ids = tuple(config.ple_layer_ids or ())
        ...
        self.uses_ngram_embedding = any(
            start_layer <= layer_id < end_layer for layer_id in ple_layer_ids
        )
