...
title model-recipes bench-parallel - gemma4-31b
...
rem ----   stress a deep prefix-cache resume. The KVarN tiers' head-512
rem ----   slow path makes deep-ctx climbs glacial - keep tokens modest
rem ----   there, or climb the fp8 tiers (8032/8033) for the real record.
rem ---- The climber is the shared _shared\scripts\bench_parallel.py, run
rem ---- inside the WSL distro. The tier must already be up; this bat
rem ---- never boots, parks, or kills anything.
...
echo ============================================================
echo.
echo The tier must already be up: start-gemma-dual.bat or
echo start-gemma-dual-nomtp.bat. This bat never boots, parks, or kills anything.
echo.
