...
title model-recipes bench-parallel - qwen3.8-27b
...
rem ----   stress a deep prefix-cache resume, the shape the mamba pre-copy
rem ----   fix guards. The tier must already be up; this bat never boots it.
...
echo ============================================================
echo.
echo The tier must already be up: start-mtp.bat, start-nomtp.bat,
echo start-superfast.bat, start-kvarntier.bat,
echo start-kvarnmtp.bat, or start-kvarndflash2.bat. This bat never
echo boots, parks, or kills anything.
echo.
