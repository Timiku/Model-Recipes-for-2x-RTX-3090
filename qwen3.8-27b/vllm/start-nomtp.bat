...
title model-recipes serve - qwen3.8-27b / nomtp.yml (nomtp tier)
...
set "YML=nomtp.yml"
set "PORT=8113"
set "CNAME=qwen-27b-nomtp-serve"
set "WAIT=5"
...
echo  stance: NOMTP - the box's machine .env, vllm\nomtp.env, now:
echo          SPEC_N=0, drafter OFF - this tier's identity. The drafter-on
echo          tier is start-mtp.bat: its own package yml + machine .env.
echo.
